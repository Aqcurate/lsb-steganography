...
class Ui_dialog(object):
    def setupUi(self, dialog):
        ...
        self.decode_cancel_btn = QtWidgets.QPushButton(dialog)
        self.decode_cancel_btn.setObjectName("decode_cancel_btn")
        self.horizontalLayout.addWidget(self.decode_cancel_btn)
    ...
    def retranslateUi(self, dialog):
        ...
        self.decode_cancel_btn.setText(_translate("dialog", "Cancel"))
